...
name: 对话入口内联图片/视频生成
description: 对话入口屏的「产品海报」「产品视频」快捷按钮直接注入虚拟 AI 消息，在对话流中展开 InlineImageCard / InlineVideoCard
---

## Purpose

使「产品海报」「产品视频」快捷按钮直接在对话流中展开 InlineImageCard / InlineVideoCard 参数面板，用户原地配置参数、生成和查看结果，无需跳转到简报页。
