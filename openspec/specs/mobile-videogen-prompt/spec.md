---
capability: mobile-videogen-prompt
name: 移动端产品视频 prompt 模板
description: 移动端工作台①对话屏的产品视频快捷填充模板
---

## Purpose

提供移动端工作台①对话屏快捷工具栏中"产品视频"按钮的 prompt 模板行为：将结构化视频 prompt 模板填入输入框，用户替换占位参数后发送。
