...
Provide a minimal service health endpoint for verifying that the AllyGo Marketing Agent backend is running and reachable. Used for load balancer health checks and local development verification.
