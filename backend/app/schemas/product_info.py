...
class Identity(BaseModel):
    ...
    product_name: SourcedStr = Field(default_factory=SourcedStr, description="官方产品名称，须来自官网/包装/文档")
    brand: SourcedStr = Field(default_factory=SourcedStr, description="产品品牌")
    manufacturer: SourcedStr = Field(default_factory=SourcedStr, description="产品的生产公司")
    industry: SourcedStr = Field(default_factory=SourcedStr, description="产品所属行业")
    category: SourcedStr = Field(default_factory=SourcedStr, description="产品类别")


class OfficialDescription(BaseModel):
    """官方描述。优先从官网原文摘录（quoted）。"""

    description: SourcedStr = Field(default_factory=SourcedStr, description="官网的介绍文本")
    tagline: SourcedStr = Field(default_factory=SourcedStr, description="官方 slogan/标语")
    statement: SourcedStr = Field(default_factory=SourcedStr, description="正式定义，来自 PR/whitepaper")
...
class Availability(BaseModel):
    ...
    status: SourcedStr = Field(default_factory=SourcedStr, description="产品状态：在售/预售/停售/unknown")
    ...
    access_model: SourcedStr = Field(default_factory=SourcedStr, description="交付方式，如线下零售/线上直销")
